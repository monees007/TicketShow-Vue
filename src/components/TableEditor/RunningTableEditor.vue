...
export default {
  ...
  methods: {
    ...
    async update_records() {
      try {
        this.loading = true;
        const response = await fetch("http://127.0.0.1:4433/api/bulk/running", {
          method: 'GET',
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {key: "theatre_id", label: "Theatre", type: "text", editable: true,},
        {key: "show_id", label: "Show", editable: true},
        {key: "date", label: "Timings", editable: true},
